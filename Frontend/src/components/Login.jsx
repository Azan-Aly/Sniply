...
const Login = () => {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center bg-slate-50 px-4 py-12 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl border border-slate-200/80 p-7 sm:p-9 relative z-10 animate-in fade-in zoom-in-95 duration-300">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl sm:text-3xl font-display font-extrabold text-slate-900">Welcome Back</h2>
          <p className="text-sm text-slate-500 mt-1">Log in to manage your shortened links and analytics</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4.5">
          ...
          {/* Extra Links */}
          <div className="text-center text-sm text-slate-500 mt-3 pt-4 border-t border-slate-100">
